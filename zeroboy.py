...
logo = """ -----------------------------•◈•
(  __)\\ ____--------------_------------•◈•
|__(~)    •||•THE - dark cybar -OFFICAL------•◈•
|__\~~) •||• - dark---------------•◈•
|__(-----\  •◈•-----Tanvir---_(`-') (`-') _ (`-') <-.(`-') (`-') (`-') _ <-. (`-')_ (`-') _ (`-') ( (OO ).-> (OO ).-/ <-.(OO ) __( OO) ( OO).-> (OO ).-/ \( OO) ) _(OO ) (_) <-.(OO ) \ .'_ / ,---. ,------,)'-'. ,--. / '._ / ,---. ,--./ ,--/,--.(_/,-.\ ,-(`-'),------,) '`'-..__) | \ /`.\ | /`. '| .' / |'--...__)| \ /`.\ | \ | |\ \ / (_/ | ( OO)| /`. ' | | ' | '-'|_.' || |_.' || /) `--. .--''-'|_.' || . '| |)\ / / | | )| |_.' | | | / :(| .-. || . .'| . ' | | (| .-. || |\ |_ \ /_)(| |_/ | . .' | '-' / | | | || |\ \ | |\ \ | | | | | || | \ |\-'\ / | |'->| |\ \ `------' `--' `--'`--' '--'`--' '--' `--' `--' `--'`--' `--' `-' `--' `--' '--' -----•◈•
|__~~~\ •◈•-----█-------⑦-------█------•◈•
|__~~~\ •◈•-----█-------⑧-------█------•◈•
|__~~~\ •◈•-----█-------⑥-------█------•◈•
\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92m Dark tanvir
\033[1;96mInstagram \033[1;93m: \033[1;Flowtanvir
\033[1;96mFacebook  \033[1;93m: \033[1; Darktanvir4072
